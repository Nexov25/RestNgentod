...
router.get('/checkapikey', async (req, res, next) => {
	...
	json = JSON.stringify({
		status: false,
		apikey: `Apikey ${apikey} tidak valid silahkan register/login terlebih dahulu.`
	})
}
...
router.get('/scriptbot', (req, res) => {
    res.sendFile(__path + '/views/scriptbot.html')
})
