...
// Visitor
$.getJSON("https://api.countapi.xyz/hit/ronzz-api.herokuapp.com/visitor", function(response) {
    $("#visitors").text(response.value);
})

// User Login
$.getJSON("https://api.countapi.xyz/hit/ronzz-api.herokuapp.com/userlogin", function(response) {
    $("#userlogin").text(response.value);
})

// Request Today
$.getJSON("https://api.countapi.xyz/hit/ronzz-api.herokuapp.com/requesttoday1", function(response) {
    $("#requesttoday").text(response.value);
})

// Total Request
$.getJSON("https://api.countapi.xyz/hit/ronzz-api.herokuapp.com/totalrequest", function(response) {
